...
const MaterialRequestBuilderSchema = new mongoose.Schema(
  {
    ...
    deliveryUpdateToken: { type: String, default: "" },
    deliveryUpdateTokenExpiresAt: { type: Date, default: null },
    deliveryUpdateSubmittedAt: { type: Date, default: null },
    deliveryUpdateSubmittedBy: { type: String, default: "" },
